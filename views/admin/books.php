...
$sql = "SELECT * FROM tblbooks WHERE category = 'Science' ";
                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <div class="d-flex align-items-center m-3">
                            ...
                            <input type="text" id="searchInput" class="form-control border-0 shadow-none" placeholder="Search Books" aria-label="Search..." />
                        </div>
                    </div>

				...
				<div class="col-xxl-3 col-sm-6 col-12">
						<div class="card mb-4">
							<div class="card-body d-flex align-items-center p-0">
								<div class="p-4">
								<a href="students.php">
									<i class="bi bi-file-person-fill fs-1 lh-1 text-primary"></i>
								</a>
								</div>
								<div class="py-4">
									<h5 class="text-secondary fw-light m-0">Users</h5>
									<h1 class="m-0 text-primary"><?php include 'counts/students.php' ?></h1>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="card-body d-flex align-items-center p-0">
								<div class="p-4">
									<a href="Issuedbooks.php">
										<i class="bi bi-box-arrow-down-right fs-1 lh-1 text-primary"></i>
									</a>
								</div>
								<div class="py-4">
									<h1 class="m-0"><?php include 'counts/issuebook.php' ?></h1>
									<h5 class="text-secondary fw-light m-0">Book Issued</h5>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xxl-3 col-sm-6 col-12">
						<div class="card mb-4">
							<div class="card-body d-flex align-items-center p-0">
								<div class="p-4">
								<a href="Issuedbooks.php">
									<i class="bi bi-hand-thumbs-up-fill fs-1 lh-1 text-primary"></i>
								</a>
								</div>
								<div class="py-4">
									<h1 class="m-0"><?php include 'counts/returnedbook.php' ?></h1>
									<h5 class="text-secondary fw-light m-0">Book Returned</h5>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xxl-3 col-sm-6 col-12">
						<div class="card mb-4">
							<div class="card-body d-flex align-items-center p-0">
								<div class="p-4">
								<a href="Issuedbooks.php">
									<i class="bi bi-hand-thumbs-down-fill fs-1 lh-1 text-danger"></i>
								</a>
								</div>
								<div class="py-4">
									<h1 class="m-0"><?php include 'counts/notreturned.php' ?></h1>

									<h5 class="text-secondary fw-light m-0">Not Returned</h5>
								</div>
							</div>
						</div>
					</div>
